...
export default function PengajarPage() {
  ...
  const [activeTab, setActiveTab] = useState<"all" | "ustadz" | "ustadzah">(
    "all"
  );
  ...
  const filterTeachers = () => {
    ...
    if (selectedInstitution !== "all") {
      filtered = filtered.filter(
        (teacher) =>
          teacher.institution === selectedInstitution ||
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (showEditModal && selectedTeacher) {
        setTeachers(
          teachers.map((t) => (t.id === selectedTeacher.id ? savedTeacher : t))
        );
      } else {
  ...
  const stats = {
    ...
    tk: teachers.filter(
      (t) => t.institution === "TK" || t.institution === "ALL"
    ).length,
    sd: teachers.filter(
      (t) => t.institution === "SD" || t.institution === "ALL"
    ).length,
    smp: teachers.filter(
      (t) => t.institution === "SMP" || t.institution === "ALL"
    ).length,
    sma: teachers.filter(
      (t) => t.institution === "SMA" || t.institution === "ALL"
    ).length,
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="p-6">
            ...
            <DialogHeader>
              ...
              <DialogDescription className="text-gray-600">
                {showEditModal
                  ...
                  : "Tambahkan pengajar baru ke dalam sistem"}
              </DialogDescription>
            </DialogHeader>
        ...
        <Dialog
          ...
          onOpenChange={() => setShowDetailModal(false)}
        >
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-white">
            <DialogHeader>
              <DialogTitle className="text-gray-900">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg">
                    ...
                    {selectedTeacher.birthDate && (
                      <div>
                        ...
                        <p className="font-medium">
                          {formatDate(selectedTeacher.birthDate)}
                        </p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg">
                    ...
                    {selectedTeacher.experience && (
                      <div>
                        ...
                        <p className="font-medium">
                          {selectedTeacher.experience} tahun
                        </p>
                      </div>
                    )}
              ...
              teachers.map((teacher) => (
                <tr key={teacher.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-4">
                    <span
                      className={`px-2 py-1 text-xs font-medium rounded-full ${
                        teacher.institution === "TK"
                          ? "bg-yellow-100 text-yellow-800"
                          : teacher.institution === "SD"
                          ? "bg-green-100 text-green-800"
                          : teacher.institution === "PONDOK"
