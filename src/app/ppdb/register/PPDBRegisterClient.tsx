...
export default function PPDBRegisterClient() {
  ...
  const steps = [
    {
      number: 1,
      title: "Data Calon Santri/Siswa",
      icon: User,
      subtitle: "Informasi pribadi dan alamat",
    },
    {
      number: 2,
      title: "Data Orang Tua/Wali",
      icon: Users,
      subtitle: "Informasi ayah, ibu, dan wali",
    },
    {
      number: 3,
      title: "Data Pendidikan Sebelumnya",
      icon: School,
      subtitle: "Riwayat dan pilihan program",
    },
    {
      number: 4,
      title: "Upload Dokumen",
      icon: FileText,
      subtitle: "Berkas pendukung pendaftaran",
    },
    {
      number: 5,
      title: "Pilihan Program & Konfirmasi",
      icon: CheckCircle,
      subtitle: "Review dan konfirmasi data",
    },
  ];
  ...
  const validateStep = (step: number): boolean => {
    ...
    switch (step) {
      ...
      case 3:
        if (!formData.level)
          newErrors.level = "Jenjang pendidikan wajib dipilih";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        router.push(
          `/ppdb/success?id=${result.data.id}&no=${result.data.registrationNo}`
        );
      } else {
    ...
    try {
      ...
      if (result.success) {
        ...
        updateFormData("documents", [
          ...((formData as any).documents || []).filter(
  ...
  const handleDocumentDelete = async (documentType: string) => {
    ...
    try {
      const response = await fetch(
        `/api/ppdb/upload?registrationId=${registrationId}&documentType=${documentType}`,
        {
          method: "DELETE",
        }
      );
    ...
    switch (currentStep) {
        ...
        return (
          <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateFormData("fatherNik", e.target.value)
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateFormData("fatherJob", e.target.value)
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateFormData("fatherEducation", e.target.value)
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateFormData("fatherIncome", e.target.value)
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                  >
            ...
            <div className="bg-pink-50 p-6 rounded-lg">
              <h4 className="text-lg font-semibold mb-4 text-pink-900">
                Data Ibu
              </h4>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateFormData("motherNik", e.target.value)
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                    placeholder="NIK ibu"
                    maxLength={16}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateFormData("motherJob", e.target.value)
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateFormData("motherEducation", e.target.value)
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                  >
                    <option value="">Pilih pendidikan</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateFormData("motherIncome", e.target.value)
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                  >
                    <option value="">Pilih range</option>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateFormData("guardianRelation", e.target.value)
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateFormData("guardianAddress", e.target.value)
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                ...
                <>
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updateFormData("gradeTarget", e.target.value)
                      }
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updateFormData("programType", e.target.value)
                      }
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                    >
                  ...
                  {formData.level === "PONDOK" && (
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          updateFormData("boardingType", e.target.value)
                        }
                        className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 ${
                          errors.boardingType
                            ? "border-red-500"
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-yellow-700 text-sm mt-1">
                        Santri yang mondok wajib tinggal di asrama dan mengikuti
                        seluruh kegiatan pondok. Biaya asrama sudah termasuk
                        makan 3x sehari dan laundry.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      case 5:
        return (
          <div className="space-y-6">
            <h3 className="text-xl font-semibold mb-4">
              Pilihan Program & Konfirmasi Data
            </h3>
            ...
            <div className="space-y-4">
              {[
                ...
                {
                  type: "ijazah",
                  label: "Ijazah/Raport Terakhir",
                  required: formData.level !== "TK",
                },
                {
                  type: "sehat",
                ...
                {
                  type: "kip",
                  label: "Kartu Indonesia Pintar (jika ada)",
                  required: false,
                },
              ].map((doc) => {
                const uploadedDoc = (formData.documents || []).find(
                  (d) => d.type === doc.type
                );
                  ...
                  >
                    ...
                    {uploadedDoc && (
                      <div className="text-xs text-gray-500 mb-2">
                        ...
                        {(uploadedDoc as any).fileSize
                          ? ((uploadedDoc as any).fileSize / 1024).toFixed(1)
                          : "0"}{" "}
                        KB)
                      </div>
                    )}
                    ...
                    <div className="flex items-center gap-4">
                      <label className="flex-1">
                        ...
                        />
                        <div
                          className={`px-4 py-2 text-white rounded-lg text-center transition-colors ${
                            isUploading
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-green-700 text-sm mt-1">
                    Silakan periksa kembali data yang telah Anda isi sebelum
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
              <label className="flex items-start gap-3">
                ...
                <span className="text-sm text-gray-700">
                  ...
                  dapat dipertanggungjawabkan. Saya bersedia menerima
                  konsekuensi jika terdapat data yang tidak sesuai.
                </span>
              </label>
            </div>
          </div>
